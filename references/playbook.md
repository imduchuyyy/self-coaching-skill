...
## Group 1 low — thin prompts

- **Four-line opener** for deep tasks: Goal / Constraints / Context /
  Output format. Four lines, not four paragraphs.
...
## Group 4 low — no skill transfer

- **Add "and explain why"** on tasks in the domain they want to own.
